...
class CompForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['site_link'].widget.attrs.update({'class': 'input', 'placeholder': 'Enter Website Address'})
        self.fields['comp_link'].widget.attrs.update({'class': 'input', 'placeholder': 'Enter Link Address'})
